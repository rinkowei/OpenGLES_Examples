...
Camera camera((float)SCREEN_WIDTH / (float)SCREEN_HEIGHT, 0.1f, 10.0f, glm::vec3(0.0f, 0.0f, 7.0f));
...
int main()
{
	...
	GLuint cubeTextureID = textureLoader::loadTexture2D(resources_dir + "textures/9.transformations/face.png", true);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// rotation
		model = glm::rotate(model, currentFrame * glm::radians(90.0f), glm::vec3(0.5f, 0.2f, 0.8f));
